...
Puedes indicar otro monitor, por ejemplo `--encode-test 2`. La prueba codifica 60 frames a 60 FPS y 8 Mbps en memoria, muestra el tamaño resultante y termina. Usa la resolución actual de la pantalla.
